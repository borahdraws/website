...
public class Turret extends SubsystemBase {
  ...
  PIDController turretPID = new PIDController(1.0, 0.0, 0.06);

  Mechanism2d turretMechanismContainer = new Mechanism2d(5.0, 5.0);

  MechanismRoot2d turretRoot = turretMechanismContainer.getRoot("Turret Anchor Point", 2.5, 2.5);

  MechanismLigament2d turretMechanism =
      turretRoot.append(
          new MechanismLigament2d("Turret", 1.0, 0.0, 6.0, new Color8Bit(Color.kPurple)));

  MechanismLigament2d targetMechanism =
      turretRoot.append(
          new MechanismLigament2d(
              "Target the turret aims for", 0.7, 0.0, 3.0, new Color8Bit(Color.kRed)));
